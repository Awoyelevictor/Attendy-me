...
import { Flame, Trophy, Award, Zap, ChevronUp, Star, Shield, ArrowUpRight, Search, Sparkles, Target, HelpCircle, Check, Info } from 'lucide-react';
        ...
        {showTierGuide && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setShowTierGuide(false)}
                className="w-full py-3 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white font-bold text-xs rounded-xl shadow-lg shadow-orange-600/30 transition-all"
              >
      ...
      {top3.length > 0 && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
          ...
          {top3[0] && (
            ...
            >
              <div className="absolute top-3 left-3 flex items-center gap-1 px-3 py-0.5 rounded-full bg-amber-500/20 border border-amber-500/40 text-[10px] font-black text-amber-300 animate-pulse">
                👑 #1 Champion
              </div>
              <div className="relative mt-2 mb-3">
