...
export default function ForgotPassword() {
  ...
  // Active guide tab in Step 2: 'spam' | 'inbox' | 'promotions' | 'sandbox'
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800/60 p-6 sm:p-8 rounded-3xl shadow-2xl">
          ...
          {step === 1 && (
            <form onSubmit={handleRequestOtp} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800/50 border border-slate-700/50 rounded-xl py-3.5 pl-12 pr-4 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all"
              ...
              >
                {loading ? <Loader2 className="animate-spin" size={20} /> : 'Send 6-Digit OTP Code'}
              </button>
          ...
          {/* STEP 2: OTP Verification & Animated Where-to-Find Guide */}
          {step === 2 && (
            <div className="space-y-6">
              ...
              >
                {loading ? <Loader2 className="animate-spin" size={20} /> : 'Verify Code & Proceed'}
              </button>
              ...
              {/* ANIMATED INTERACTIVE GUIDE: WHERE TO FIND YOUR OTP */}
              <div className="border border-slate-800 bg-slate-950/60 rounded-2xl p-4 sm:p-5 overflow-hidden">
                  ...
                  {activeGuideTab === 'spam' && (
                    ...
                    >
                      ...
                      <p className="leading-relaxed text-slate-300">
                        Major mail providers (Gmail, Outlook, Yahoo) frequently categorize automated security codes and OTP emails into your <strong>Spam</strong> or <strong>Junk</strong> directory.
                      </p>
                ...
                {/* Instant Sandbox Helper for Dev/Preview Environments */}
                {sandboxOtp && (
                  <motion.div 
                    initial={{ opacity: 0, scale: 0.95 }}
                    animate={{ opacity: 1, scale: 1 }}
                    className="mt-4 p-3 bg-indigo-950/80 border border-indigo-500/40 rounded-xl flex items-center justify-between"
                  >
                    <div>
                      <div className="text-[11px] font-bold text-indigo-300 uppercase tracking-wider flex items-center gap-1.5">
                        <Sparkles size={12} className="text-amber-400" />
                        <span>Instant Sandbox OTP Preview</span>
                      </div>
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 shadow"
                    >
                      {copiedOtp ? (
                        <>
          ...
          {step === 4 && (
            <div className="text-center py-4 space-y-6">
              ...
              <button
                ...
                className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-indigo-600/20"
              >
                Sign In Now
              </button>
            </div>
